function lgraph = unet_resnet50_se_BS_dropout(inputSize,show)
...
lgraph = connectLayers(lgraph,"dropout","conv_11");
lgraph = connectLayers(lgraph,"dropout","conv_14");
lgraph = connectLayers(lgraph,"dropout","gapool_1");
lgraph = connectLayers(lgraph,"dropout","multiplication_1/in2");
...
lgraph = connectLayers(lgraph,"dropout_1","conv_24");
lgraph = connectLayers(lgraph,"dropout_1","conv_27");
lgraph = connectLayers(lgraph,"dropout_1","gapool_2");
lgraph = connectLayers(lgraph,"dropout_1","multiplication_2/in2");
...
lgraph = connectLayers(lgraph,"dropout_2","conv_43");
lgraph = connectLayers(lgraph,"dropout_2","conv_46");
lgraph = connectLayers(lgraph,"dropout_2","gapool_3");
lgraph = connectLayers(lgraph,"dropout_2","multiplication_3/in2");
